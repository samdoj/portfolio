    ...
    render() {
        return (
            <div style={{
                position: 'absolute',
                height: '100vh',
                width: this.state.width > 600 ? '100vw' : '80vw',
                overflow: 'scroll',
                top: '15vh',
                left: this.state.width > 600 ? 0 : '10vw',
                alignContent: 'center',
                alignItems: 'center'
            }}>
                <Typography
                ...
                >
                    ...
                    <Grid item sm={6} lg={4} xl={3}><CodeCard func={codeFunctions.fizzBuzz}
                                                              component={() => <FizzBuzz/>}
                    ...
                    <Grid sm={6} item lg={4} xl={3}><CodeCard func={codeFunctions.quickSort}
                                                              code={codeText.quickSort}
                                                              title="Quick Sort"
                                                              component={() => <QuickSort/>}/></Grid>
                    <Grid sm={6} item lg={4} xl={3}><CodeCard func={codeFunctions.binarySearch}
                    ...
                    }}><a href='mailto:joedmasonsd%40gmail.com?subject=Code%20sample%20suggestion'>Suggest a code
                        sample</a></Card></Grid>
                </Grid>
